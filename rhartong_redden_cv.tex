...
\begin{indentsection}{\parindent}
	\begin{itemize}
		\parskip=-0.1em
		\item Graduated with honor in both degrees, Cumulative GPA: 3.7/4.0
...
\subsection*{Skills}
	\begin{indentsection}{\parindent}
		...
		\textbf{Machine Learning:} Convolutional Neural Networks, Gradient Boosted Machines \\
		\textbf{ML Tools:} Keras, TensorFlow, XGBoost\\	\textbf{Data:} SQL, Postgres, HDF5 \\
		\textbf{Dev Tools:}  Git, Heroku, PyCharm, AWS \\  
		\textbf{Python Stack:} Conda, Jupyter, matplotlib, NumPy, Pandas, PyTables, scikit-learn, SQLAlchemy \\
...
\begin{itemize}
	...
	\item
	\headerrow
		{\textbf{Software Development}}{San Francisco, CA}\\
	\headerrow
		{}
		{\emph{May 2015--Present}}
	\begin{itemize*}
		\item Currently working through \emph{Bayesian Methods for Hackers}
		\item Studying best practices for object-oriented programming in Ruby and Python
