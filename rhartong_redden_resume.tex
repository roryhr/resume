...
\begin{itemize}
	...
	\begin{itemize*}
		\item Promoted to lead the data science team, expanded our models to instantly quote CNC and Injection Molding using ML models predicting cycle time
	\end{itemize*}
\end{itemize}

\begin{itemize}
	\jobitem{Fast Radius}{Chicago, IL}
		     {Data Scientist and Technical Manager}{Feb 2020--Jan 2021}
	\begin{itemize*}
		...
		\item The data science team owns features end-to-end so I'd occasionally write Elixir, JavaScript, and Terraform get our stuff working
	\end{itemize*}
\end{itemize}
\begin{itemize}
