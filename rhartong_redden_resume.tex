...
\begin{itemize}
	...
	\begin{itemize*}
		\item Lead the data science team, expanded CNC coverage and estimated lead times
	\end{itemize*}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, scikit-learn, Flask, AWS ECS, Docker
		\item Founding data scientist, built out a costing API for instantly quoting additive parts
	\end{itemize*}
\end{itemize}
