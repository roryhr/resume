...
\begin{tabular}{p{0.5\linewidth}   p{0.5\linewidth}} 
	Python, MATLAB, Elixir, SQL, Git, Bash
	& Spark, Hadoop, S3 \\
...
\begin{itemize}
	\jobitem{SyBridge (acquired Fast Radius)}{Boulder, CO}
		     {Data Science Lead}{Feb 2021--Present}
	\begin{itemize*}
		\item Tech stack: Python, scikit-learn, Flask, Docker, AWS ECS
		\item Lead the data science team, expanded our models to cover CNC and plastic molding
	\end{itemize*}
\end{itemize}
