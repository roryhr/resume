...
\subsection*{Summary}
\begin{centering}  
data scientist and technical manager\\
\end{centering}
...
\begin{itemize}
	\jobitem{Fast Radius}{Boulder, CO}
		     {Data Science Manager}{Feb 2020--Present}
	\begin{itemize*}
		\item Tech stack: Python, Elixir, AWS ECS, Docker, REST API
		\item My team (and I) build services to predict the cost of making a part and how long it will take
	\end{itemize*}
\end{itemize}
