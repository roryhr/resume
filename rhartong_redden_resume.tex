...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Aligned with cross-functional teams on pricing models and setup a lightweight configuration database using the Microsoft Graph API 
	\end{itemize*}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, Flask, Docker, AWS ECS, Datadog, Metabase, GitHub
%		\item Deployed a Dockerized machine learning model powering our eCommerce contract manufacturing business, progressing from ad hoc statistical data exploration to production deployment, to instantly generate customer quotes for the FDM 3D printing process
	    \item Founding data scientist: developed, deployed, and maintained the first cost-prediction regression models, contributing to the early growth of the platform		\item Predicted shipping costs using mixed integer programming to pack boxes as input for the UPS API
		...
		\item I dipped into the Phoenix Elixir backend, JavaScript frontend, and Terraform infrastructure as needed to fix bugs and remove blockers
	\end{itemize*}
\end{itemize}
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, SQL, Spark, Hadoop, Flume, Oozie, Hive, Kafka, GitHub
		\item Led the design and deployment of a ``People You Might Know" feature using Spark's GraphX extension in order to bootstrap a social network to improve the retention rate
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, pandas, Spark, Julia, PostGIS, Keras, TensorFlow
		\item Trained machine learning models and using a large internal telematics dataset to predict risk and develop new product ideas
		\item Co-authored a research paper titled ``Real-time Prediction of Intermediate-Horizon Automotive Collision" with the Stanford Intelligent Systems Lab using Monte Carlo simulation and deep learning
	\end{itemize*}
\end{itemize}
