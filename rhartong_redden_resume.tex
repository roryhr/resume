...
%\vspace{-0.4em}
\begin{centering}  
machine learning scientist, python developer\\
%excited about reinforcement learning and Bayesian optimization\\
\end{centering}
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Developed a production FinTech data pipeline for algorithmic currency trading using XGBoost
