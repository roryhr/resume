...
\subsection*{Summary}
\begin{centering}  
Experienced data scientist with a bent towards software engineering with eight years of experience from analytics, data engineering, to machine learning\\
\end{centering}
%\hrule
...
%		\item Mentored and coached junior data scientists, elevating the team's analytical capabilities and fostering a culture of continuous learning and improvement
		\item Our APIs were in the path of revenue so we ensured it highly available though high-quality code, a comprehensive test suite, and synthetic Datadog tests in the production environment
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, scikit-learn, Flask, Docker, AWS ECS, Datadog, Metabase
