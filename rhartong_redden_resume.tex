...
\begin{itemize}
	...
	\begin{itemize*}
       	 	\item Led a 3-person data science team, partnering with product and engineering to develop and deploy key products featured in our IPO documents
...
%		\item Built an ETL pipeline to anonymize customer data to comply with GDPR regulations
	        \item Designed and deployed a ``People You Might Know" feature using Python, Spark, and Hadoop, improving user retention
...
%		\item Trained machine learning models and analyzed telematics and crash data to predict risk
	        \item Developed and trained machine learning models using Python, pandas, TensorFlow, and Spark to predict risk based on telematics and crash data
