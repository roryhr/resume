...
\begin{itemize}
	...
	\begin{itemize*}
		\item Consulting within the data science organization to move workloads onto AWS and incorporate best practices like CI/CD, testing, and defining infrastructure as code
	\end{itemize*}
\end{itemize}
