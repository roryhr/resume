...
\begin{itemize}
	...
	\begin{itemize*}
		\item Created SQL queries and visualizations in Metabase of training data and prediction errors
...
%		\item Mentored and coached junior data scientists, elevating the team's analytical capabilities and fostering a culture of continuous learning and improvement
		\item Maintained high-quality code essential for generating revenue supported by a comprehensive test suite and automated Datadog tests to ensure optimal latency and uptime
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: Python, scikit-learn, Flask, Docker, AWS, Metabase
		\item Developed a machine learning model for our eCommerce part manufacturing business, progressing from ad hoc statistical data exploration to production deployment, to instantly generate customer quotes for the FDM 3D printing process
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Tech stack: MATLAB, SolidWorks, \LaTeX, TikZ
		\item Thesis research: Measured Faraday waves using a novel image processing technique for cheap 3D high-speed mm-resolution measurement over a surface area of $225 \,\mathrm{cm}^2$ 
	\end{itemize*}
