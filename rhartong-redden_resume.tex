...
\begin{tabular}{p{0.5\linewidth}   p{0.5\linewidth} } 
	...
	\textbf{Database:} PostgreSQL, SQL 	
	& \textbf{Machine Learning:}  Neural Networks, Decision Trees  \\
	
	\multicolumn{2}{l}{\textbf{Python Stack:} Keras, NumPy, Pandas, PyTables, , scikit-learn, SQLAlchemy } \\
\end{tabular}
\end{indentsection}
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Trained, backtested, and ran a leading supervised learning model for currency trading 
...
%		\item Incorporated the latest discoveries in astronomy and the new \emph{Cosmos} into my lessons
	...
	\begin{itemize*}
		\item Incorporated a cheap and clever 3D fluid surface measurement using MATLAB for high-speed, mm-resolution measurements over an area of $225 \,\mathrm{cm}^2$
