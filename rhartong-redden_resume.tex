...
\begin{itemize}
	...
	\begin{itemize*}
		\item Trained industry-standard machine learning models for currency trading 
		\item Backtested and optimized trading algorithms
	\end{itemize*}
\end{itemize}
...
%		\item Currently working through \emph{Bayesian Methods for Hackers}
		\item Participated in the Walmart, Yelp, and Winton Kaggle competitions
		\item Learned object-oriented programming with Ruby and Python
		\item Deployed a Twitter clone in Rails to Heroku by following the \emph{Ruby on Rails Tutorial} 
	\end{itemize*}
