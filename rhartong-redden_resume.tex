...
\begin{centering}  
data scientist, physicist, coder, all-around nice guy\\
\end{centering}
...
\begin{tabular}{p{0.5\linewidth}   p{0.5\linewidth} } 
	...
	& \textbf{ML:} Regression, Neural Networks, Decision Trees  \\
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Developed a pipeline for applying machine learning to trading 
...
%		\item Incorporated the latest discoveries in astronomy and the new \emph{Cosmos} into my lessons
	...
	\begin{itemize*}
		\item Incorporated an image processing technique for cheap 3D high speed mm-resolution measurement over a surface area of $225 \,\mathrm{cm}^2$
