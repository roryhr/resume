...
%\textbf{Data:} Pandas, SQLAlchemy, Postgres 	& \textbf{Machine Learning:}  Keras, scikit-learn  \\
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Deployed a Python app to heroku running a Twisted framework to ingest 800MB a day from a live websocket feed into a Postgres database (learned asynchronous programming)
		\item Exploring feasibility of neural networks for use in algorithmic trading
	\end{itemize*}
\end{itemize}
...
%		\item Exploring machine learning tools in scikit-learn on Kaggle datasets
		\item Learning object-oriented programming with Ruby, Python
		\item Built a Twitter clone with the \emph{Ruby on Rails Tutorial} and learned to use Rails, Heroku, and Git
	\end{itemize*}
